...
- [⬤] **修正仓库头按钮溢出**：手机上仓库头 Watch/Fork/Star/Sponsor 一行若不换行/收缩，Sponsor 会顶出主列并在右侧留下空白。脚本会强制该行换行并允许按钮收缩（可在面板关闭）。
- [⬤] **左侧悬浮导航**：在仓库主页，自动索引页内所有含 More 切换的导航条形栏（全局头部、仓库标签条等），将 More 下拉项与既有导航项按顺序合并罗列在左侧悬浮导航栏中。悬浮球常驻显示，点击悬浮球或油猴菜单「展开/收起悬浮导航」可展开/收起面板。
